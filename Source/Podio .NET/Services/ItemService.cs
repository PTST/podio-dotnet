...
namespace PodioAPI.Services
{
    public class ItemService
    {
        ...
        public async Task<long> AddNewItem(long appId, Item item, long? spaceId = null, bool silent = false, bool hook = true)
        {
        ...
        public async Task<long?> UpdateItem(Item item, long? spaceId = null, long? revision = null, bool silent = false, bool hook = true)
        {
            JArray fieldValues =
                JArray.FromObject(
        ...
        /// </summary>
        public async Task<Item> GetItemByAppItemId(long appId, long appItemId)
        {
        ...
        /// <param name="offset">The offset longo the returned items, defaults to 0</param>
        ...
        /// <returns></returns>
        public async Task<PodioCollection<Item>> FilterItems(long appId, long? limit = 30, long? offset = 0, Object filters = null,
        ...
        /// <returns></returns>
        public async Task<FileResponse> GetItemsAsXlsx(long appId, Dictionary<string, string> filters, long limit = 20, long offset = 0,
            bool deletedColumns = false, string sortBy = null, bool sortDesc = true, long? viewId = null)
        {
        ...
        public async Task<long> ExportItems(long appId, string exporter, ExportFilter filter)
        {
        ...
        /// <param name="offset">The offset longo the list of items to export</param>
        ...
        /// <returns>The id of the batch created for this export</returns>
        public async Task<long> ExportItems(long appId, string exporter, long? limit = null, long? offset = null, long? viewId = null,
        ...
        /// <param name="includeFiles">True to include files when getting filtered items, defaults to false</param>
        /// <returns></returns>
        public async Task<PodioCollection<Item>> FilterItemsByView(long appId, long viewId, long limit = 30, long offset = 0,
        ...
        /// <returns></returns>
        public async Task<List<Item>> GetTopValuesByField(long fieldId, long limit = 13, long[] notItemIds = null)
        {
        ...
        /// <param name="fieldId"></param>
        /// <returns></returns>
        public async Task<T> GetItemFieldValues<T>(long itemId, long fieldId) where T : new()
        {
        ...
        /// <param name="fieldId"></param>
        /// <returns></returns>
        public async Task<Models.Range> GetFieldRanges(long fieldId)
        {
        ...
        /// <param name="itemId"></param>
        /// <returns></returns>
        public async Task<ItemRevision> GetItemRevision(long itemId, long revision)
        {
        ...
        /// <returns></returns>
        public async Task<List<ItemMicro>> GetReferencesToItemByField(long itemId, long fieldId, long limit = 20)
        {
            var requestData = new Dictionary<string, string>()
            {
                {"limit", limit.ToString()}
        ...
        public async System.Threading.Tasks.Task UpdateItemReference(long itemId, string type, long referenceId)
        {
            dynamic requestData = new
            {
                type = type,
        ...
        public async Task<long?> RevertItemRevision(long itemId, long revisionId)
        {
        ...
        public async Task<long?> RevertToRevision(long itemId, long revision)
        {
        ...
        /// <returns></returns>
        public async Task<List<Item>> FindReferenceableItems(long fieldId, long limit = 13, long[] notItemIds = null,
        ...
        /// <returns></returns>
        public async Task<List<ItemDiff>> GetItemRevisionDifference(long itemId, long revisionFrom, long revisionTo)
        {
            string url = string.Format("/item/{0}/revision/{1}/{2}", itemId, revisionFrom, revisionTo);
            return await _podio.Get<List<ItemDiff>>(url);
        }

        public async Task<ItemCalculate> Calcualate(long itemId, ItemCalculateRequest ItemCalculateRequest, long limit = 30)
        {
